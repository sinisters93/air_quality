# -*- coding: utf-8 -*-
"""
This script imports data from CSV files, performs data manipulation, and generates a bar plot
comparing EC (Elemental Carbon) and OC (Organic Carbon) concentrations across months.
